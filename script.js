let phrases = [
  ...
  { text: 'поиграть в популярные игры', image: '2.png' },
  { text: 'скрафтить незеритовую мотыгу и не понять зачем она тебе', image: '3.png' },
  { text: 'поиграть в Роблокс', image: '4.png' },
  { text: 'посмотреть смешные мемасики', image: '5.png' },
  ...
  { text: 'не забыть погладить кошку!', image: '1.png' },
